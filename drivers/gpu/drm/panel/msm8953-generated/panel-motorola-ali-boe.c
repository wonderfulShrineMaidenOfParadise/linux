...
static int boe_565_v0_on(struct boe_565_v0 *ctx)
{
	...
	mipi_dsi_dcs_write_seq(dsi, 0xe4, 0x01, 0x01);
	usleep_range(5000, 6000);
	mipi_dsi_dcs_write_seq(dsi, 0xe6, 0x00, 0x08);
	usleep_range(10000, 11000);
	mipi_dsi_dcs_write_seq(dsi, 0xe5,
			       0x00, 0x00, 0x02, 0x03, 0x05, 0x00, 0x00, 0x00,
			       0x00, 0x00, 0x00, 0x01, 0x05, 0x1e, 0x17, 0x0d,
			       0xae, 0x0c, 0x20, 0x02, 0x04, 0x02, 0x08, 0x02,
			       0x07, 0x06, 0x00, 0x05, 0x06, 0x02, 0x01);
	usleep_range(10000, 11000);
	...
	mipi_dsi_dcs_write_seq(dsi, 0xca,
			       0x23, 0x23, 0x23, 0x23, 0x23, 0x23, 0x22, 0x20,
			       0x20);
